...
let mkdll, mkexe, mkmaindll =
  ...
  if Sys.os_type = "Win32" then
    try
      ...
      flexlink ^ " -maindll"
    with Not_found ->
      "gcc -shared", "gcc -O2 -fno-strict-aliasing -fwrapv -Wall -Wdeclaration-after-statement -Werror -fno-common -fexcess-precision=standard -fno-tree-vrp -ffunction-sections -D_FILE_OFFSET_BITS=64 -D_REENTRANT -DCAML_NAME_SPACE  -Wl,-E", "gcc -shared"
  else
    "gcc -shared", "gcc -O2 -fno-strict-aliasing -fwrapv -Wall -Wdeclaration-after-statement -Werror -fno-common -fexcess-precision=standard -fno-tree-vrp -ffunction-sections -D_FILE_OFFSET_BITS=64 -D_REENTRANT -DCAML_NAME_SPACE  -Wl,-E", "gcc -shared"
